...
function calc_BMI() {
    ...
    0 == b ? ($("#bmi_value").text(""), $("#bmi_level").text(" "), $("#indicator").text("Por favor, complete o formulário.")) : (a = 1E4 * a / (b * b), $("#bmi_value").text(a.toFixed(2)), 30 < a ? ($("#bmi_level").text("Obeso"), $("#indicator").text("Eita! você está extremamente acima do peso."), $("#DietTittle").text("Procure um médico!"), $("#Diet").text("Profissionais da área de Nutrição afirmam que, pessoas nesse nível podem acarretar: problemas respiratórios, cardiovasculares e diabetes. Buscar ajuda de profissionais imediata é extremamente recomendado nesse nível de IMC."))
     ...
     : ($("#bmi_value").text(""), $("#bmi_level").text(""), $("#indDieticator").text("Por favor, complete o formulário.")))
}
